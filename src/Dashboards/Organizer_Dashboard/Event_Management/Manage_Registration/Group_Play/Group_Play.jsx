            ...
            <div className="p-4 space-y-6">
              ...
              <div className="border rounded-lg p-4 shadow-md bg-white">
                <div className="flex flex-col  gap-5">
                  <p className="text-md font-semibold">Players Groups:</p>
                  <hr />
                  <div className="flex items-center gap-5 justify-around max-lg:flex-col">
                    <p className="text-md font-semibold">Group 1:</p>
                    <p className="text-md font-semibold">Player A</p>
                    <p className="text-md font-semibold">Player B</p>
                    <p className="text-md font-semibold">Player C</p>
                    <p className="text-md font-semibold">Player D</p>
                    
                  </div>
                  <div className="flex items-center gap-5 justify-around max-lg:flex-col">
                    <p className="text-md font-semibold">Group 2:</p>
                    <p className="text-md font-semibold">Player A</p>
                    <p className="text-md font-semibold">Player B</p>
                    <p className="text-md font-semibold">Player C</p>
                    <p className="text-md font-semibold">Player D</p>
              ...
              <div className="border rounded-lg p-4 shadow-md bg-white">
                ...
                <div className="mt-2 space-y-1">
                  <hr />
                  <div className="flex items-center my-5 gap-10 max-lg:flex-col max-lg:gap-5">
                    <div className="border rounded-xl py-2 px-3 bg-gray-300">
                      <p className="text-md">Player F</p>
                    </div>
                    <div className="border rounded-xl py-2 px-3 bg-gray-300">
                      <p className="text-md">Player G</p>
                    </div>
                    <div className="border rounded-xl py-2 px-3 bg-gray-300">
