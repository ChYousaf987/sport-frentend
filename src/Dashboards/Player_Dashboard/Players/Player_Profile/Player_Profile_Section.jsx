...
const Player_Profile_Section = () => {
  ...
  const handleSponsorClick = () => {
    // Placeholder action for sponsoring
    console.log(`Initiating sponsor action for ${name}`);
    // TODO: Implement actual sponsor functionality (e.g., open modal, redirect, or API call)
  };
              ...
              <div className="flex flex-col gap-3 w-[50%] justify-center items-center max-lg:w-[100%]">
                ...
                <div className="flex gap-5 justify-center items-center">
                  ...
                  <button
                    ...
                    className="py-2 px-5 text-white bg-[#E45252] rounded-full"
                ...
                <div className="grid gap-10 grid-cols-3 sm:grid-cols-5 mt-5">
...
export default Player_Profile_Section;
