...
const Player_Financial_Management = () => {
  ...
  return (
    <>
      ...
      <div className="absolute top-20 right-0 bg-[#FAFAFA] w-[75%] max-lg:w-full max-lg:mt-10">
...
export default Player_Financial_Management;
