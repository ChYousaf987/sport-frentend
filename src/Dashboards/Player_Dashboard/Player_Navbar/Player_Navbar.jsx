...
const SearchBar = ({
  ...
  return (
    ...
    >
      ...
      <input
        type="text"
        placeholder="Search for players, events, or organizers"
        ...
        aria-label="Search players, events, or organizers"
      />
      {showDropdown && (
        <div className="absolute top-12 left-0 bg-white rounded-lg shadow-lg w-full z-50 border border-gray-200">
          ...
          <ul className="text-sm">
            ...
            <li
              className="px-4 py-2 hover:bg-gray-50 cursor-pointer flex items-center gap-2"
              onClick={(e) => handleSearchType(e, "Event")}
            >
              <FiSearch className="text-gray-500" /> For Events
            </li>
          </ul>
        </div>
      )}
...
const Player_Navbar = ({ onSearch, onFilter }) => {
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-7 py-2 min-h-screen px-5">
          ...
          <h1 className="text-3xl font-semibold">Welcome, Players</h1>
          ...
          <div className="flex flex-col gap-10 cursor-pointer">
            ...
            <NavLink
              onClick={() => setSidebarOpen(false)}
              to="/PLayer_Financial_Management"
              className={getNavLinkClass}
            >
