          ...
          <div key={index} className="px-2 my-5  ">
            <div className="bg-white rounded-b-lg shadow-md overflow-visible relative">
              ...
              <p className="font-semibold">Event Title: {card.title}</p>
                ...
                <div className="text-center rounded-lg p-2 w-[5rem] h-[4rem] " style={{border:'2px solid black'}}>
                    <p className="font-bold text-lg">{card.members}</p>
                    <p className=" text-sm">Members</p>
                  </div>
               </div>
                <div className="flex justify-end items-center mt-3">
                  <Link to='/visitorEventdetail' className="hover:bg-red-400 bg-red-500 text-white px-4 py-2 rounded-full text-md">
                    Learn More
                  </Link>
                </div>
              </div>
