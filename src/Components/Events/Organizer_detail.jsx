            ...
            <div className=" -z-50 " >
                ...
                <div className="landing-bg bg-[#333333] w-[100%]  flex flex-col h-[48rem]  max-lg:min-h-[auto] max-lg:h-[42rem]">
                    <div className="flex mt-32 justify-between px-10 max-lg:mt-3 max-lg:px-3">
                        <p className="text-3xl font-bold text-white">Organizer Details</p>
                    ...
                    <div className="w-[100%] flex flex-col justify-center items-center mt-5 ">
                        ...
                        <p className="text-[#999999] -ml-14">Organizer</p>
                        ...
                        <div className="flex justify-center w-[80%] gap-20 mt-8 max-lg:flex-wrap max-lg:gap-5 max-lg:justify-evenly max-lg:w-[100%] max-lg:px-3 ">
...
export default Organizer_detail
