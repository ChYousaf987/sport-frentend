...
const ProfileView = () => {
    return (
        <div className='pt-32 max-lg:pt-8'>
            <div className="w-[50%] bg-[#333333] pt-5 pb-10 mb-10 rounded-lg flex flex-col gap-5 mx-auto justify-center items-center max-lg:w-[98%] " style={{ border: '1px solid #e45352' }}>
                <div className="flex justify-between w-[90%]  max-lg:mt-0 ">
                    <div></div>
                    <NavLink to='/boost' className="">
                ...
                <NavLink to='/PaymentMethod' className='w-[50%] bg-[#405de6] p-2 rounded-lg text-white  cursor-pointer flex justify-center max-lg:w-[60%] '>Proceed To Pay</NavLink>
