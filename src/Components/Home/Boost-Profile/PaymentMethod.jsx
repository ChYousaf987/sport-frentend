...
const PaymentMethod = () => {
  ...
  return (
    ...
    <form onSubmit={SubmitData} className="w-[40%] bg-[#000000] pt-5 pb-10 mb-10 rounded-lg flex flex-col gap-5 mx-auto justify-center items-center max-lg:w-[98%] " style={{ border: '1px solid #e45352' }}>
        <div className="flex justify-between w-[90%]  max-lg:mt-0 ">
            <div></div>
            <div className='text-2xl font-semibold text-white'>Payment Method</div>
            <NavLink to='/ProfileView' className="">
